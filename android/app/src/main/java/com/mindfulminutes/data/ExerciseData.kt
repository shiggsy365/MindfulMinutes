...
val EXERCISES = listOf(
    // Breathing
    Exercise("b1", "breathing", "Box Breathing", 3, listOf("Breathe in slowly through your nose for 4 counts.", "Hold your breath gently for 4 counts.", "Exhale slowly through your mouth for 4 counts.", "Hold empty for 4 counts. Repeat the cycle.", "With each round, feel your heartbeat slow and your mind settle.")),
    ...
    Exercise("b3", "breathing", "Ocean Breath", 3, listOf("Slightly constrict the back of your throat.", "Inhale deeply through your nose, creating a soft ocean-like sound.", "Exhale slowly through your nose with the same gentle constriction.", "Let the rhythm of your breath become the rhythm of waves.", "Continue for several minutes, riding each wave of breath.")),
    Exercise("b4", "breathing", "Belly Breathing", 2, listOf("Place one hand on your chest and one on your belly.", "Breathe in deeply so only your belly hand rises.", "Exhale and feel your belly gently fall.", "Keep your chest hand as still as possible.", "Continue, feeling the gentle rise and fall like a sleeping child.")),
    ...
    Exercise("b6", "breathing", "Counted Exhale", 2, listOf("Inhale naturally without counting.", "Exhale slowly, counting each second: one... two... three...", "Try to extend your exhale a little longer each time.", "Aim for an exhale that's twice as long as your inhale.", "Feel your nervous system shift toward calm with each breath.")),
    Exercise("b7", "breathing", "Straw Breathing", 1, listOf("Inhale deeply through your nose.", "Purse your lips as if breathing through a tiny straw.", "Exhale as slowly as possible through your pursed lips.", "Feel the controlled release of air grounding you.", "Repeat five times, each exhale longer than the last.")),
    Exercise("b8", "breathing", "Energising Breath", 2, listOf("Sit tall and take three normal breaths to settle.", "Begin quick, rhythmic breaths through your nose — equal inhale and exhale.", "Keep breaths short and pumping from the diaphragm for 15 seconds.", "Stop and take one long, deep breath in. Hold for 5 counts.", "Exhale slowly. Notice the tingling aliveness in your body.")),
    Exercise("b9", "breathing", "Sighing Release", 1, listOf("Inhale deeply through your nose, filling your lungs completely.", "Let out an audible sigh — a big, dramatic exhale through your mouth.", "Feel the release of tension with the sound.", "Inhale again deeply. Sigh it out even louder.", "Three more sighs, each one letting go of something you're carrying.")),
    Exercise("b10", "breathing", "Candle Breathing", 2, listOf("Imagine a candle flame at arm's length in front of you.", "Inhale deeply through your nose.", "Exhale so gently that you would only make the flame flicker, not go out.", "Focus entirely on the smoothness and control of your exhale.", "Continue for ten breaths, each softer than the last.")),
